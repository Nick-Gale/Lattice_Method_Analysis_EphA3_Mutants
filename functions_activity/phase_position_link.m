...
if scan_type == "ANATOMY"
    [CTOF_full_field_positions, CTOF_full_collicular_positions, FTOC_full_field_positions, FTOC_full_collicular_positions] = anatomical_map(connections, collicular_positions_RC, collicular_positions_ML, retinal_positions_NT, retinal_positions_DV);
...
if scan_type == "SCANNER"
    ...
    [min(CTOF_full_field_positions(:,1)), max(CTOF_full_field_positions(:,1)), min(CTOF_full_field_positions(:,2)), max(CTOF_full_field_positions(:,2))]
